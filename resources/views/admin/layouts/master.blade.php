...
{{--    <link  rel="stylesheet" type="text/css" href="{{asset('css/all-admin.css')}}">--}}
    ...
    <nav class="sidebar-nav">
        <ul class="nav">
            ...
            <li class="nav-item nav-dropdown">
                <a class="nav-link nav-dropdown-toggle" href="#"><i class="icon-people"></i>کـــاربـران</a>
                <ul class="nav-dropdown-items">
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('users.create')}}"><i class="icon-user-follow"></i>کاربر جدید</a>
            ...
            <li class="nav-item nav-dropdown">
                <a class="nav-link nav-dropdown-toggle" href="#"><i class="icon-people"></i>مطالـــب</a>
                <ul class="nav-dropdown-items">
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('posts.create')}}"><i class="icon-user-follow"></i>مطلب جدید</a>
                        <a class="nav-link" href="{{route('posts.index')}}"><i class="icon-people"></i> لیست مطالب</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item nav-dropdown">
                ...
                <ul class="nav-dropdown-items">
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('categories.create')}}"><i class="icon-user-follow"></i>دسته بندی جدید</a>
                        <a class="nav-link" href="{{route('categories.index')}}"><i class="icon-people"></i>لیست دسته بندی ها</a>
                    </li>
                </ul>
            </li>

            <li class="nav-item nav-dropdown">
                <a class="nav-link nav-dropdown-toggle" href="#"><i class="icon-puzzle"></i>فایل</a>
                <ul class="nav-dropdown-items">
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('photos.index')}}"><i class="icon-user-follow"></i>لیست فایل ها</a>
                        <a class="nav-link" href="{{route('photos.create')}}"><i class="icon-people"></i>فایل جدید</a>
                    </li>
                </ul>
            </li>
        ...
        <div class="tab-pane active" id="timeline" role="tabpanel">
            ...
            <div class="callout callout-danger m-a-0 p-y-1">
                ...
                <div class="avatars-stack m-t-h">
                    ...
                    <div class="avatar avatar-xs">
                        <img src="/admin/img/avatars/avatar.jpg" class="img-avatar" alt="admin@bootstrapmaster.com">
                    </div>
                </div>
            </div>
            <hr class="m-x-1 m-y-0">
...
<script src="/admin/js/libs/Chart.min.js"></script>

{{--<script type="javascript" src="{{asset('js/all-admin.js')}}" ></script>--}}
...
<script src="/admin/js/libs/pace.min.js"></script>
